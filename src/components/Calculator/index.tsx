...
//             <div className="flex">
//               <span className="bg-blue-100 px-3 py-2 rounded-l-md border border-r-0 border-gray-300">£</span>
//               <input
//                 type="number"
//                 value={loanAmount ?? ''}
...
//                   placeholder="25"
//                 />
//                 <span className="bg-blue-100 px-3 py-2 rounded-r-md border border-l-0 border-gray-300">years</span>
//               </div>
//             </div>
...
//             <label className="block text-sm mb-1">Mortgage Type</label>
//             <div className="flex flex-col gap-2">
//               <label className="flex items-center gap-2 bg-white border border-gray-300 rounded-md px-3 py-2">
//                 <input
//                   type="radio"
//                   name="mortgageType"
//                   value="repayment"
